...
- three [B2-15](https://www.ovhcloud.com/asia/public-cloud/prices/){.external} front-end web servers
- two [C2-30](https://www.ovhcloud.com/asia/public-cloud/prices/){.external} database servers
...
- the *scaling* scenario consists of adding another [B2-15](https://www.ovhcloud.com/asia/public-cloud/prices/){.external} front-end web server.”
